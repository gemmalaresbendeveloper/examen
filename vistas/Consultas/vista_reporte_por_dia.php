...
<div class="contendor_kn">
  <div class="panel panel-default">
    <div class="panel-heading">
        <h2><b>REPORTE DE CONSULTAS POR DÍA</b></h2>            
    </div>
    <div class="panel-body">
        <div class="col-md-12">
          <div class="box-body table-responsive" style="text-align: center;"><br>
          	<label>LISTADO DE CONSULTAS REGISTRADAS</label>
              <div id="listar_consultas_por_dia" class=" icon-loading">
                <i id="loading_almacen" style="margin:auto;display:block; margin-top:60px;"></i>
                <div id="nodatos"></div>
              </div>
              <p id="paginador_consultas_por_dia" style="text-align:right" class="mi_paginador"></p>
          </div>
      </div>
    </div>
  </div>
...
<!-- INICIO MODAL -->
<script type="text/javascript">listar_consultas_por_dia("","1");</script>
<!--Fin Modal-->
...
<script type="text/javascript">
	$("#txt_documento_vista").keyup(function(){
		...
		listar_consultas_vista(dato_buscar,'1');
	});
</script>
<script>
    $(function () {
