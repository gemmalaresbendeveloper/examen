function listar_consultas_vista(valor,pagina){

	var pagina = Number(pagina);
	$.ajax({
		url:'../controlador/consultas/controlador_ListarBuscar_documento.php',
		type: 'POST',
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				cadena += "<th style = 'text-align: center;width: 20px;word-wrap: break-word;'>PACIENTE</th>";
				cadena += "<th style = 'text-align: center;width: 150px;word-wrap: break-word;'>MÉDICO</th>";
				cadena += "<th style = 'text-align: center;width: 150px;word-wrap: break-word;'>DIAGNÓSTICO</th>"
				cadena += "<th style = 'text-align: center;width: 120px;word-wrap: break-word;''>TRATAMIENTO</th>";
				cadena += "<th style = 'text-align: center;width: 30px;word-wrap: break-word;'>COSTO</th>";
				cadena += "</tr>";
				cadena += "</thead>";
				cadena += "<tbody>";
				for(var i = 0 ; i<valores.length; i++){
					...
					cadena += "<td style = 'text-align: center;width: 150px;word-wrap: break-word;'>"+valores[i][4]+"</td>";//paciente
					cadena += "<td style = 'text-align: center;width: 150px;word-wrap: break-word;'>"+valores[i][6]+"</td>";//medico
					cadena += "<td style = 'text-align: center;width: 150px;word-wrap: break-word;'>"+valores[i][8]+"</td>";//diagnostico
					cadena += "<td style = 'text-align: center;width: 150px;word-wrap: break-word;'>"+valores[i][1]+"</td>";//tratamiento
					cadena += "<td style = 'text-align: center;width: 150px;word-wrap: break-word;'>"+valores[i][3]+"</td>";//costo
					cadena += "</tr>";
				}
				cadena += "</tbody>";
				cadena += "</table>";
				...
				if(pagina>1){
					paginar += "<li><a href='javascript:void(0)' onclick='listar_consultas_vista("+'"'+valor+'","'+1+'"'+")'>&laquo;</a></li>";
					paginar += "<li><a href='javascript:void(0)' onclick='listar_consultas_vista("+'"'+valor+'","'+(pagina-1)+'"'+")'>Anterior</a></li>";
				}
				else{
				...
				for(i = pagina_inicio;i<=pagina_fin;i++){
					if(i==pagina){
						...
						paginar += "<li><a href='javascript:void(0)' onclick='listar_consultas_vista("+'"'+valor+'","'+i+'"'+")'>"+i+"</a></li>";
					}
				}
				if(pagina < numero_paginas){
					paginar += "<li><a href='javascript:void(0)' onclick='listar_consultas_vista("+'"'+valor+'","'+(pagina+1)+'"'+")'>Siguiente</a></li>";
					paginar += "<li><a href='javascript:void(0)' onclick='listar_consultas_vista("+'"'+valor+'","'+numero_paginas+'"'+")'>&raquo;</a></li>";
				}
				else{
...
function listar_consultas_por_dia(valor,pagina){

	var pagina = Number(pagina);
	$.ajax({
		url:'../controlador/consultas/controlador_ListarBuscar_consultas_por_dia.php',
		type: 'POST',
		data:'valor='+valor+'&pagina='+pagina+'&boton=buscar',
		beforeSend: function(){
			$("#loading_almacen").addClass("fa fa-refresh fa-spin fa-3x fa-fw");
		...
		success: function(resp){
			...
			if(valores.length>0){
				...
				cadena += "<thead  class=''>";
				cadena += "<tr >";
				cadena += "<th style = 'text-align: center;width: 80px;word-wrap: break-word;'>FECHA</th>";
				cadena += "<th style = 'text-align: center;width: 150px;word-wrap: break-word;'>MÉDICO</th>";
				cadena += "<th style = 'text-align: center;width: 150px;word-wrap: break-word;'>TOTAL CONSULTAS</th>"
				cadena += "<th style = 'text-align: center;width: 120px;word-wrap: break-word;''>TOTAL COSTO</th>";
				cadena += "</tr>";
				cadena += "</thead>";
				cadena += "<tbody>";
				for(var i = 0 ; i<valores.length; i++){
					cadena += "<tr>";			
					cadena += "<td  style = 'width: 80px;word-wrap: break-word;color:#9B0000; text-align:center;font-weight: bold;'>"+valores[i][0]+"</td>";
					cadena += "<td style = 'text-align: center;width: 150px;word-wrap: break-word;'>"+valores[i][1]+"</td>";
				...
				cadena += "</tbody>";
				cadena += "</table>";
				$("#listar_consultas_por_dia").html(cadena);
				var totaldatos = datos[1];
				var numero_paginas = Math.ceil(totaldatos/5); 
				var paginar = "<ul class='pagination'>";
				if(pagina>1){
					paginar += "<li><a href='javascript:void(0)' onclick='listar_consultas_por_dia("+'"'+valor+'","'+1+'"'+")'>&laquo;</a></li>";
					paginar += "<li><a href='javascript:void(0)' onclick='listar_consultas_por_dia("+'"'+valor+'","'+(pagina-1)+'"'+")'>Anterior</a></li>";
				}
				else{
					paginar += "<li class='disabled'><a href='javascript:void(0)'>&laquo;</a></li>";
					paginar += "<li class='disabled'><a href='javascript:void(0)'>Anterior</a></li>";
				...
				for(i = pagina_inicio;i<=pagina_fin;i++){
					if(i==pagina){
						...
						paginar += "<li><a href='javascript:void(0)' onclick='listar_consultas_por_dia("+'"'+valor+'","'+i+'"'+")'>"+i+"</a></li>";
					}
				}
				if(pagina < numero_paginas){
					paginar += "<li><a href='javascript:void(0)' onclick='listar_consultas_por_dia("+'"'+valor+'","'+(pagina+1)+'"'+")'>Siguiente</a></li>";
					paginar += "<li><a href='javascript:void(0)' onclick='listar_consultas_por_dia("+'"'+valor+'","'+numero_paginas+'"'+")'>&raquo;</a></li>";
				}
				else{
					paginar += "<li class='disabled'><a href='javascript:void(0)'>Siguiente</a></li>";
					paginar += "<li class='disabled'><a href='javascript:void(0)'>&raquo;</a></li>";
				...
				paginar += "</ul>";
				$("#paginador_consultas_por_dia").html(paginar);
			}else{
				var cadena = "";
				cadena += "<table  class='table table-condensed jambo_table'>";
				cadena += "<thead  class=''>";
				...
				cadena += "</table>";
				$("#listar_consultas_por_dia").html(cadena);
				$("#paginador_consultas_por_dia").html("");
			}
		},
		error: function(XMLHttpRequest, textStatus, errorThrown, jqXHR){
			alert("SE PRODUJO UN ERROR");
...
function AbrirModalArchivo_documentoNS(control){
...
function AbrirModalAsuntoDocumentoNS(control){
	var datos = control.name;
	var datos_split = datos.split("*");
...
function AbrirModalDocumentoNS(control){
	var datos = control.name;
	var datos_split = datos.split("*");
...
function AbrirModalVerRemitenteNS(control){
	var datos = control.name;
	var datos_split = datos.split("*");
...
function BuscarRemitenteCiudadanoNS(control) {
	$.ajax({
...
function BuscarRemitenteInstitucionNS(control) {
	$.ajax({
...
function Listar_diagnostico_combo() {
	$.ajax({
		url:'../controlador/medicos/controlador_combolistar_diagnostico.php',
		type:'POST'
	})
	.done(function(resp) {
		var data = JSON.parse(resp);
		if (data.length > 0) {
			var cadena = "";
				cadena += "<option value='otro'>"+"SELECCIONAR DIAGNÓSTICO"+"</option>";
			for (var i = 0; i < data.length; i++) {
				cadena += "<option value='"+data[i][0]+"'>"+data[i][1]+"</option>";
			}
			$("#combo_tipo_diagnostico").html(cadena);	
		}
		else{
...
function Listar_pacientes_combo() {
	$.ajax({
		url:'../controlador/pacientes/controlador_combolistar_pacientes.php',
		type:'POST'
	})
	.done(function(resp) {
		var data = JSON.parse(resp);
...
function Listar_medicos_combo() {
	$.ajax({
		url:'../controlador/medicos/controlador_combolistar_medicos.php',
		type:'POST'
	})
	.done(function(resp) {
		var data = JSON.parse(resp);
...
function Registrar_documentoNS(){
...
function Registrar_documento_post(){
	$(document).on('submit', '#create-form-documento', function() { 
      ...
      $.ajax({  
        ...
        url:'../controlador/consultas/controlador_registrar_documento.php',
        ...
        success:function(resp) {
          if(resp>0){
			...
			.then ( ( value ) =>  { 
				  $("#main-content").load("Consultas/vista_documento_listar.php"); 
			});
          }else{
...
function listar_verificardocumento_vistaNS(valor,pagina){
	var pagina = Number(pagina);
	$.ajax({
...
function AbrirfuncionAceptarSolicitudNS(control){
	var datos       = control.name;
	var datos_split = datos.split("*");
	swal({
...
function AbrirfuncionRechazarSolicitudNS(control){
	var datos       = control.name;
	var datos_split = datos.split("*");
	swal({
